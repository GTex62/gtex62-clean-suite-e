...
-- arcs read at a glance by brightness, INFRA is white — fixed visual
-- conventions, not palette-dependent (same precedent as theme.astro).
-- CAM is new (no legacy tier): it takes the palette accent so the
-- innermost arc stays distinct from the exhausted gray ramp.
----------------------------------------------------------------
theme.pf_markers   = {
  ...
  CAM   = { r = 12, color = palette.accent },             -- palette accent
}
